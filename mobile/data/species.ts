...
export const sampleSpeciesData: BambooSpecies[] = [
  ...
  },
  {
   ...
   image: require('@/assets/images/bolo.jpg'),
    ...
    category: 'Clumping',
    rarity: 'Common',
    origin: 'Philippines (also cultivated in Borneo and parts of Southeast Asia)',
   ...
   image: require('@/assets/images/golden_buho.jpg'),
    ...
    category: 'Clumping',
    rarity: 'Uncommon',
    origin: 'Philippines (cultivated in Ifugao, Benguet, Mt. Makiling)',
  ...
  },
  {
    ...
    category: 'Running',
    rarity: 'Uncommon',
    origin: 'Colombia (introduced in the Philippines)',
  ...
  },
  {
    ...
    image: require('@/assets/images/kawayan_tinik.jpg'), // adjust as needed
    height: '15–25 m',
    category: 'Clumping',
    rarity: 'Common',
    origin: 'Philippines (also Indonesia)',
    growthRate: 'Fast',
    sunlight: 'Full Sun to Partial Shade',
